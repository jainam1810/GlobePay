        ...
        <div className="min-h-screen grid place-items-center px-6">
            <div className="w-full max-w-sm">
                <div className="flex items-center gap-2.5 justify-center mb-8 fade-up">
                    <div className="grid h-10 w-10 place-items-center rounded-xl bg-[var(--accent)] text-[var(--accent-ink)] font-display font-bold text-xl shadow-[0_0_24px_var(--accent-glow)]">G</div>
                ...
                <form onSubmit={submit} className="card p-6 fade-up delay-1">
                    ...
                    {err && <div className="mt-4 text-xs text-[var(--danger)] bg-[var(--danger-soft)] border border-[var(--danger-line)] rounded-lg px-3 py-2">{err}</div>}

...
- **Misclassification flag (roadmap, after reconciliation):** on Contractors page, risk-score each contractor from `classificationSignals` (looks employee-like?). Respects domestic/cross-border. The "AI genuine reasoning" feature.

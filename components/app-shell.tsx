...
export default function AppShell({ children }: { children: React.ReactNode }) {
    ...
    // The admin console and client portal bring their own shells; auth pages
    // have none. This legacy shell only wraps the original single-tenant pages.
    if (["/admin", "/portal", "/login", "/route"].some((p) => pathname.startsWith(p))) {
        return <>{children}</>;
    }
